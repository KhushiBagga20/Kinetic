...
- Lead with the direct answer in one or two sentences, then the supporting detail. Use short markdown sections or bullets when there is more than one dimension.
